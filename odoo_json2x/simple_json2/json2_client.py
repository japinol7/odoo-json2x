...
class Json2Client:
    ...
    # ---------------------------
    def _handle_response(self, response: httpx.Response) -> JSON:
    ...
    def get_db_list(self):
        ...
        response = jsonrpc_client.post(url, json=payload)
    ...
    def get_server_version_data(self):
        ...
        response = jsonrpc_client.get(url)
        return self._handle_response(response)
